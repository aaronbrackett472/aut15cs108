...
<%
	...
	} else if (request.getAttribute("sendrequest") != null) {
		message = (String)request.getAttribute("sendrequest");
	} else if (request.getAttribute("challenge") != null) {
		message = (String)request.getAttribute("challenge");
	}
...
<body>
	...
	<h4 style="text-align:left;"><span style="font-weight:normal;"><a href="AllNoteMessages.jsp">Messages<%if (numMsgs >0) { %>(<%=numMsgs%>)<%}%></a></span> &bull; 
